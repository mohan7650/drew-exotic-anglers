              ...
              {isEditing ? (
                ...
                <>
                  ...
                  <div className="tfish-info">
                    ...
                    {item.latin_name && (
                      <span className="tfish-latin">{item.latin_name}</span>
                    )}
                    {item.description && (
                      <span className="tfish-desc">{item.description}</span>
                    )}
                    <div className="tfish-meta">
                      {item.difficulty && (
                        <span className="tfish-difficulty">Difficulty: {item.difficulty}</span>
                      )}
                      {stars > 0 && (
                  ...
                  <div className="tfish-row-actions">
                    <button
                      ...
                      disabled={isDeleting || !!editingId || addOpen}
                    >
                      Edit
                    </button>
                    <button
